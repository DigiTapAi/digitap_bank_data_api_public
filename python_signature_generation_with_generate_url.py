...
def get_sign(payload):
    ...
    recipient_key = RSA.import_key(open("your public key path").read())
...
request_params = {
    ...
    "client_ref_num": "client ref num",
    "txn_completed_cburl": " client webhook",
    "start_month": "2021-01",
    "end_month": "2021-01",
    "institution_id": "25",
    # Need to replace with client return url
    "return_url": "https://www.google.com/"


}
url = 'Digitap Generate URL API endpoint'

report_payload = json.dumps(request_params)
report_sign = get_sign(report_payload)
print(report_sign)

call_digitap_api(url, request_params, report_sign, '')
